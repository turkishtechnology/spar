...
export default function Features() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/img/features-bg.svg')",
    ...
    >
      <div className='features-grid'>
        <div className='features-col'>
          <div className='features-card' style={{ backgroundColor: color }}>
        ...
        <div className='features-col'>
          <div className='features-card' style={{ backgroundColor: color }}>
            <div className='features-card-content'>
              ...
              <div className='features-card-content-text'>
                <div className='features-title'>
                  <Translate description='Smart Focus Handling'>features.focus.handling</Translate>
                </div>
                <div className='features-desc'>
