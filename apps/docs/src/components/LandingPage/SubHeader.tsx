    ...
    <div className='subheader-container'>
      <div className='subheader-title-group'>
        <div className='subheader-title-icon'>
          ...
          <Translate description='WHY TAKEOFF HEADLESS'>landing.why.takeoff.headless</Translate>
        </div>
      ...
      <div className='subheader-features'>
        <div className='subheader-feature'>
          <Translate description='Speed up your workflow'>landing.speed.up.workflow</Translate>
