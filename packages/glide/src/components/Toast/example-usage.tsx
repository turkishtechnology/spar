...
function ExampleComponent() {
  ...
  const handleQueueStatus = () => {
    ...
    toastApi.info(`Queue: ${toastApi.toasts.length} visible, ${toastApi.queuedToasts.length} queued`);
  };
  ...
  return (
    <div>
      <button onClick={handleGlobalToast}>
        Show Global Toast
      </button>
      
      <button onClick={handleHookToast}>
        Show Hook Toast
      </button>
      ...
      <button onClick={handlePriorityDemo}>
        Demo Priority Queue
      </button>
      
      <button onClick={handleQueueStatus}>
        Check Queue Status
      </button>
      
      <button onClick={() => toastApi.clear()}>
        Clear All Toasts
      </button>
    </div>
  );
